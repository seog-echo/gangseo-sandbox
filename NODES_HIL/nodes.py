...
class UnifiedDBSWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.tick = 0
        # Most recent simulate_chunk() output (set each tick); used by HIL subclass.
        self._last_out: Dict[str, np.ndarray] | None = None
    ...
    def _on_tick(self) -> None:
        ...
        # Latest generated chunk, exposed so subclasses (e.g. the HIL app) can
        # route a selected channel to analog output without re-running the tick.
        self._last_out = out
